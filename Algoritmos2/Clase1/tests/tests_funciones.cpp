...
TEST(Ej, 10) {
  ...
  EXPECT_TRUE(!integrantes_repetidos(vector<Mail>{mfs("123/45;222/11"), mfs("111/11")}));
  EXPECT_TRUE(!integrantes_repetidos(vector<Mail>{mfs("123/45;222/11"), mfs("111/11;222/22")}));
  EXPECT_TRUE(!integrantes_repetidos(vector<Mail>{mfs("123/45;222/11"), mfs("111/11;222/22"), mfs("123/45;222/11")}));
  EXPECT_TRUE(!integrantes_repetidos(vector<Mail>{mfs("123/45;222/11"), mfs("111/11;222/22"),mfs("111/11;222/22"), mfs("123/45;222/11")}));
  EXPECT_TRUE(integrantes_repetidos(vector<Mail>{mfs("123/45"), mfs("123/45;222/22")}));
  EXPECT_TRUE(integrantes_repetidos(vector<Mail>{mfs("111/45;222/22"), mfs("123/45;222/22")}));
}
